...
def load_model(model_name, hparams=None):
    ...
    if model_name == "swin4d_ver7":
        ...
        elif hparams.clf_head_version == 'multi':
            from .clf_mlp_multi import FMRIToROI
            net = FMRIToROI(input_dim=192*2*2*2, output_dim=61*73*61, aal_template_path=hparams.roi_template_path)
        else:
